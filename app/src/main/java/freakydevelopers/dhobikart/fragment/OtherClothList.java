...
import static freakydevelopers.dhobikart.Resources.MyURL.CLOTHLISTOTHER;

/**
 * Created by PURUSHOTAM on 9/14/2016.
 */
public class OtherClothList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.otherclothlist, container, false);
        ...
        new GetResponse().execute(CLOTHLISTOTHER);
        return view;
